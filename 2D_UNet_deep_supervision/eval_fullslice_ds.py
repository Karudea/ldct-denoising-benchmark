...
# ---- 实验命名（改成 DS 版本）----
EXP_NAME = "DS_sigmoid_l1only_1mm_train1mm_val1mm"
SEED = 0
...
# ---- 模型路径（改成你的 DS checkpoint）----
CKPT_PATH = rf"E:\LDCT\experiments\{EXP_NAME}\best_unet_ds_sigmoid_l1only_1mm.pth"
